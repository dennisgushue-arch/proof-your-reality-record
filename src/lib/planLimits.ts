...
export const FREE_CASE_LIMIT_MESSAGE = "The Free plan includes 1 case. Upgrade to Premium for unlimited cases.";
export const FREE_INCIDENT_LIMIT_MESSAGE = "The Free plan includes 10 incidents total. Upgrade to Premium for unlimited incidents.";
