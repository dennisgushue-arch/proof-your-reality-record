...
const Index = () => (
  <div className="min-h-screen bg-background">
    ...
    <section id="pricing" className="border-t border-border scroll-mt-24">
      <div className="container py-20 text-center max-w-2xl">
        ...
        <p className="mt-4 text-muted-foreground">
          Free Plan: Create 1 case, record 10 incidents total, basic timeline, and view saved records.
          Premium: Unlock unlimited cases, unlimited incidents, AI Incident Analysis, Entity Intelligence, Timeline Intelligence, professional PDF exports, unlimited evidence uploads, priority support, and future AI features.
        </p>
    ...
    <footer className="border-t border-border container py-10">
      ...
      <p className="mt-6 text-center text-xs text-muted-foreground">(c) {new Date().getFullYear()} Proof. All rights reserved.</p>
    </footer>
  </div>
);
